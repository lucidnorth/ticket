                ...
                <div class="xxmd:w-1/3 xmd:w-full xxsm:w-full">
                    <div class="p-4 bg-white shadow-lg rounded-md">
                        ...
                        <div class="flex pt-8 flex-wrap 1xl:flex-nowrap">
                            <div class="mr-5">
                                <img src="{{ asset('images/email.png') }}" alt="" class="z-20 h-10 w-10">
                            </div>
                            <div class="">
                                <p
                        ...
                        <div class="flex pt-8 flex-wrap 1xl:flex-nowrap">
                            <div class="mr-5">
                                <img src="{{ asset('images/phone.png') }}" alt="" class="z-20 h-10 w-10">
                            </div>
                            <div>
                                <p
                                    class="font-poppins font-normal 1xl:text-xl xxmd:text-xl lg:text-base sm:text-base xxsm:text-base leading-7 text-gray-200">
                        ...
                        <div class="flex pt-8 flex-wrap 1xl:flex-nowrap">
                            <div class="mr-5">
                                <img src="{{ asset('images/address.png') }}" alt="" class="z-20 h-10 w-10">
                            </div>
                            <div>
                                <p
                                    class="font-poppins font-normal 1xl:text-xl xxmd:text-xl lg:text-base sm:text-base xxsm:text-base leading-7 text-gray-200">
                        ...
                        <div class="flex pt-8 pb-5 flex-wrap 1xl:flex-nowrap">
                            <div class="mr-5">
                                <img src="{{ asset('images/social.png') }}" alt="" class="z-20 h-10 w-10">
                            </div>
                            <div>
                                <p
                                    class="font-poppins font-normal 1xl:text-xl xxmd:text-xl lg:text-base sm:text-base xxsm:text-base leading-7 text-gray-200">
                    ...
                    <div class="">
                        ...
                        <div class="mt-5">
                            ...
                            border border-gray-light rounded-md "
                                required placeholder="Describe your message..."></textarea>
