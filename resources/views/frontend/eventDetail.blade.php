...
@section('content')
                ...
                <div class="xxmd:w-2/3 xmd:w-full xxsm:w-full">
                    ...
                    <div class="mt-8 pb-5 bg-white shadow-lg rounded-md">
                        <div
                            ...
                            <a
                                href="{{ url('/organization/' . $data->organization->id . '/' . $data->organization->name) }}">
                        ...
                        @foreach ($data->paid_ticket as $item)
                            <div class="relative rounded-lg border border-gray-light p-5 ">
                                ...
                                <div class="absolute bottom-5" style="width: 89%" >
                                    ...
                                    @else<a href="{{ url('/checkout/' . $item->id) }}"
                                            class="w-full font-poppins font-medium text-base leading-6 text-primary py-3 mt-7 border border-primary rounded-lg flex justify-center">
                                            {{ __('Buy Ticket') }}
                                            <img src="{{ asset('images/right-dropdown.png') }}" alt=""
                                                class="w-2 ml-2 h-3 mt-1.5">
                                        </a>
                                    @endif
                                </div>
                            </div>
                    ...
                    @if (count($data->free_ticket) != 0)
                        @foreach ($data->free_ticket as $item)
                            <div class="rounded-lg border border-gray-light p-5">
                                ...
                                @else<a href="{{ url('/checkout/' . $item->id) }}"
                                        class="font-poppins font-medium text-base leading-6 text-primary  py-3 flex mt-7  w-full border border-primary rounded-lg justify-center">
                                        {{ __('Buy Ticket') }}
                                        <img src="{{ asset('images/right-dropdown.png') }}" alt=""
                                            class="w-2 ml-2 h-3 mt-1.5">
                                    </a>
                ...
                <form class="form-a" method="post" action="{{ url('report-event') }}">
                    ...
                    <div class="">
                        ...
                        <div class="grid md:grid-cols-2 sm:grid-cols-1 xxsm:grid-cols-1 mt-5">
                            <div class="w-[70%]">
                                ...
                                <select id="report_reason" name="reason"
                                    class="select2 focus:outline-none text-base leading-4 font-poppins font-normal text-gray-100 block p-3 rounded-md z-20 
                            border border-gray-light">
                                    ...
                                    <option class="font-poppins font-normal text-base leading-4 text-gray-100"
                                        ...
                                        {{ 'Fraudulent of Unauthorized Event' }}</option>
                                    <option class="font-poppins font-normal text-base leading-4 text-gray-100"
                        ...
                        <div class="md:w-[85%] sm:w-[70%] xxsm:w-[70%] mt-5 flex justify-end">
                            <button
                                class="bg-primary text-white font-poppins font-medium text-lg leading-7 px-5 py-2 rounded-md">{{ __('Send Message') }}</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key={{$gmapkey}}&callback=initMap"></script>
